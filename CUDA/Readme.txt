...
compilar con nvcc blur-effect.cu -o blur-effect `pkg-config opencv --cflags -libs`
...
Para ejecutar por consola se deben pasar los siguientes parametros: "nombre imagen.extension" "tamaño del kernel" "numero de hilos por bloque" "numero de bloques".